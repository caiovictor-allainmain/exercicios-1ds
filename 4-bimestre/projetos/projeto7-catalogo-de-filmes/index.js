...
let filme1 = { titulo: "sla", genero: "nsei", ano: 2000, avaliacao: 9 }
let filme2 = { titulo: "sla", genero: "nsei", ano: 2000, avaliacao: 9 }
let filme3 = { titulo: "sla", genero: "nsei", ano: 2000, avaliacao: 9 }
let filme4 = { titulo: "sla", genero: "nsei", ano: 2000, avaliacao: 9 }
let filme5 = { titulo: "sla", genero: "nsei", ano: 2000, avaliacao: 9 }
let filme6 = { titulo: "sla", genero: "nsei", ano: 2000, avaliacao: 9 }
let filme7 = { titulo: "sla", genero: "nsei", ano: 2000, avaliacao: 9 }
let filme8 = { titulo: "sla", genero: "nsei", ano: 2000, avaliacao: 9 }
let filme9 = { titulo: "sla", genero: "nsei", ano: 2000, avaliacao: 9 }
let filme10 = { titulo: "sla", genero: "nsei", ano: 2000, avaliacao: 9 }

const sla = {filme1, filme2, filme3, filme4, filme5, filme6, filme7, filme8, filme9, filme10}

// for(let i = 1; i <= 10; i++){
//     const filme = sla[`filme${i}`]
...
console.log(`
    ...
    ${sla[`filme${filmemaior}`].titulo} (${maior})
